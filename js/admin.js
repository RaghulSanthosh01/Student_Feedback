// admin.js (Updated with Security and Sentiment Styling)
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    feedbackList.forEach(item => {
      ...
      // Basic text cells (using .textContent for security)
      ...
      // Sentiment Cell (Uses innerHTML to inject the colored <span> badge)
    ...
    // Using innerHTML here for controlled styling on the error message
    errorRow.innerHTML = 
